...
if (state == EnemyState.HURT)
{
    ...
    {
        var hurt_blocker = instance_place(x + hsp, y, obj_skeleton);
...
if (move_step != 0)
{
    ...
    var skel_blocker = instance_place(x + move_step, y, obj_skeleton);
    ...
    else
    {
        while (abs(move_step) > 0)
        {
            ...
            skel_blocker = instance_place(x + move_step, y, obj_skeleton);
            if (skel_blocker != noone && skel_blocker != id && skel_blocker.state != EnemyState.DEAD)
            {
                blocked = true;
            }
...
var overlap = instance_place(x, y, obj_skeleton);
if (overlap != noone && overlap != id && overlap.state != EnemyState.DEAD)
{
    ...
    repeat (12)
    {
        var test_overlap = instance_place(x, y, obj_skeleton);
